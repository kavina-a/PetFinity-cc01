...
return [
    ...
    */
    'routes' => [
        ...
        'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['web', 'auth:petowner,trainingcenter,boardingcenter']),
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'Chatify\Http\Controllers'),
    ],

    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'chatify/api'),
        'middleware' => env('CHATIFY_API_ROUTES_MIDDLEWARE', ['api', 'auth:petowner,trainingcenter,boardingcenter']),
